...
Spring Boot项目就会用Logback来记录日志，并用**INFO**级别输出到**控制台**
...
<configuration scan="true">
    ...
    <logger name="com.chat.demo.mapper.FileMapper" level="DEBUG" />
</configuration>
```

> <logger name="com.chat.demo.mapper.FileMapper" level="DEBUG" />
>
> 需要打印Mybatis的mapper类，level表示日志等级